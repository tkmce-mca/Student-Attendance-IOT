...
<meta name="keywords" content=Education is the key to success in life, and teachers make a lasting impact in the lives of their students. />
...
<header>
	<div class="top-head container">
		<div class="ml-auto text-right right-p">
			<ul>
				<li class="mr-3">
					<span class="fa fa-clock-o"></span> Mon-Sat : 9:00am to 5:00pm</li>
				<li>
					<span class="fa fa-envelope-open"></span> <a href="mailto:info@example.com">tkmce.ac.in</a> </li>
			</ul>
		</div>
	</div>
	<div class="container">
		...
		<nav class="py-3 d-lg-flex">
			<div id="logo">
				<h1> <a href="index.html"><img src="images/s2.png" alt=""> WE BUILD EXCELLENCE </a></h1>
			</div>
							...
							<li>
								<div class="container-fluid">
									<div class="w3ls_banner_txt">
										...
										<p class="w3ls_pvt-title my-3"><h4>“Let us remember: One book, one pen, one child and one teacher can change the world.” – ...</h4></p>
							...
							<li>
								<div class="container-fluid">
									<div class="w3ls_banner_txt">
										<h3 class="b-w3ltxt text-capitalize mt-md-4">Education Courses.</h3>
										<h4 class="b-w3ltxt text-capitalize mt-md-2">Study For Better Future</h4>
										<p class="w3ls_pvt-title my-3">“Let us remember: One book, one pen, one child and one teacher can change the world.” – ...</p>
										<a href="#about" class="btn btn-banner my-3">Read More</a>
									</div>
								</div>
							</li>
					...
					<div class="banner-form-w3 ml-lg-5">
						<div class="padding">
							...
							<form action="sreg.php" method="post">
								<h5 class="mb-3">Register and Join in our college</h5>
								<div class="form-style-w3ls">
									<input placeholder="Faculty Name" name="name" type="text" required="">
									...
									<!--<input placeholder="Password" name="password" type="password" required=""> -->
									<input type="submit" class="btn-primary" value="Get Started">
...
<section class="banner-bottom py-5" id="about">
	<div class="container py-lg-5">
		...
		<div class="row bottom-grids">
			<div class="col-md-3 col-sm-6">
				<div class="three-grids-w3pvt-1 d-flex text-right">
					<div class="text-effect-wthree midd-text-w3ls p-3 w-100">
						<h5 class="text-capitalize text-bl font-weight-bold">Facilities</h5>
						<p>Education</p>
					</div>
				</div>
			</div>
			...
			<div class="col-lg-5">
				<p class="mt-4">Educational facilities include not only classrooms but also athletic facilities and playgrounds, and even libraries off school property. RAND studies have examined the role that educational facilities have on influencing education, academic achievement, and child health and well-being</p>
			</div>
